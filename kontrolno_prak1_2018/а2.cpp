//Напишете функция, 
//която приема(1) указател към корена на дърво с произволен брой деца 
//и(2) цяло положително число N.
//Функцията трябва да върне вектор 
//от всички елементи на дървото които са на разстояние N от корена.
